 ...
 */
public class MainpageFragment extends Fragment  implements MyRecyclerViewAdapterMain.ItemClickListener {
...
//                    System.out.println("AAAAAAAA:" + user.name);
    ...
    private void initRecyclerView() {
        ...
        adapter = new MyRecyclerViewAdapterMain(thiscontext, allPosts );
